...
RSpec.describe Author type: :model do
  ...
  describe 'behaviors' do
    it 'sorts parents by earliest time created' do
      # Author.create!(name: 'Susan', living: false, pullitzer_prizes: 123, created_at: 8.seconds.ago)
      # Author.create!(name: 'James', living: false, pullitzer_prizes: 153, created_at: 9.seconds.ago)
      # Author.create!(name: 'Gloop', living: false, pullitzer_prizes: 97, created_at: 10.seconds.ago)
      # require 'pry'
      # binding.pry
